...
__always_inline void _neon_metrics_k5_n2(const int16_t *val,
					...
					int norm)
{
	int16_t * __restrict out = __builtin_assume_aligned(outa, 16);
	int16_t * __restrict sums = __builtin_assume_aligned(sumsa, 16);
    ...
    m0 = vmulq_s16(m2, m0);
    m1 = vmulq_s16(m2, m1);
    m2 = vcombine_s16(vpadd_s16(vget_low_s16(m0), vget_high_s16(m0)), vpadd_s16(vget_low_s16(m1), vget_high_s16(m1)));
...
__always_inline static void _neon_metrics_k7_n2(const int16_t *val, const int16_t *outa,
					int16_t *sumsa, int16_t *paths, int norm)
{
	int16_t * __restrict out = __builtin_assume_aligned(outa, 16);
	int16_t * __restrict sums = __builtin_assume_aligned(sumsa, 16);
...
__always_inline static void _neon_metrics_k7_n4(const int16_t *val, const int16_t *outa,
					int16_t *sumsa, int16_t *paths, int norm)
{
	int16_t * __restrict out = __builtin_assume_aligned(outa, 16);
	int16_t * __restrict sums = __builtin_assume_aligned(sumsa, 16);
